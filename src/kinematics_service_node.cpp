...
public:
    KinematicsServiceNode() : Node("kinematics_service")
    {
        ...
        this->R = std::make_shared<quik::Robot<Dynamic>>(quik::ROSHelpers::robotFromNodeParameters(*this));
        RCLCPP_INFO(this->get_logger(), "Loaded robot successfully. Robot configuration is:");
        this->R->print();

        // Build IKSolver and declare parameters
        this->IKS = std::make_shared<quik::IKSolver<Dynamic>>(quik::ROSHelpers::IKSolverFromNodeParameters(*this, this->R));
        ...
        this->ik_srv_ = this->create_service<quik::srv::IKService>(
            "ik_service",
            std::bind(&quik::ROSHelpers::ik_service_handler_, 
        ...
        this->fk_srv_ = this->create_service<quik::srv::FKService>(
            "fk_service",
            std::bind(&quik::ROSHelpers::fk_service_handler_, 
            std::placeholders::_1, std::placeholders::_2, std::placeholders::_3,
            this->R));
        ...
        this->jacobian_srv_ = this->create_service<quik::srv::JacobianService>(
            "jacobian_service",
            std::bind(&quik::ROSHelpers::jacobian_service_handler_,
            std::placeholders::_1, std::placeholders::_2, std::placeholders::_3,
            this->R));
